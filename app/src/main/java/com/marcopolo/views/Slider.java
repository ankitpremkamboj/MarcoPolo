...
public class Slider extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        LayoutParams params = new LayoutParams(Utils.dpToPx(getResources().getDimension(R.dimen._20sdp),
                getResources()), Utils.dpToPx(getResources().getDimension(R.dimen._20sdp), getResources()));
