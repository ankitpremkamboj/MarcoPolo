...
/**
 * Created by Renjith Krishnan on 23-Aug-16.
 */
public class SliderPopUp extends CustomView {
    ...
    public SliderPopUp(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = getRelativeTop(this) - getHeight() / 2;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(
                    ViewHelper.getX(ball)
                            + getRelativeLeft((View) ball.getParent())
            ...
            if (animate == false) {
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + getRelativeLeft((View) ball
                                        .getParent()) + ball.getWidth() / 2)
                                        - size);
                ViewHelper.setY(numberIndicator.numberIndicator, y - size);
                int indicatorValue = (value * (7) / 100) + 1;
                numberIndicator.numberIndicator.setText(indicatorValue + "");
            }
